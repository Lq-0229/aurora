<template>
  <div id="App-Wrapper" :class="[appWrapperClass, theme]" :style="wrapperStyle">
    ...
    <diV v-bind:style="{backgroundImage: 'url(' + backgroundUrl + ')',backgroundSize:'cover',width:'100%',height:'100%'
...
export default defineComponent({
  ...
  data(){
    return{
      ...
      backgroundUrl:'https://www.bmmx0229.top:9000/beimeng0/beimeng/image/back/9.jpg',
    }
  },
